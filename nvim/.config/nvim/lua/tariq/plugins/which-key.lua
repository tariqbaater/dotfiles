return {
	...
	config = function()
		...
		wk.add({
			...
			{ "<leader>gg", "<cmd>lua Snacks.lazygit.open()<CR>", desc = "open lazygit" },
			...
			{ "<leader>fp", "<cmd>Projects <CR>", desc = "Projects files" },
			...
			{ "<leader>tf", "<cmd>FloatTerm <CR>", desc = "floating terminal" },
