...
<reference>
@/Users/tariq/.config/opencode/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/tariq/.config/opencode/get-shit-done/references/user-profiling.md` to load:
