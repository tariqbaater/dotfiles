...
Reference full template: `/Users/tariq/.config/opencode/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/tariq/.config/opencode/get-shit-done/templates/state.md`.
