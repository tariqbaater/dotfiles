...
<!-- For checkpoint task examples and patterns, see @/Users/tariq/.config/opencode/get-shit-done/references/checkpoints.md -->
...
See `/Users/tariq/.config/opencode/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/tariq/.config/opencode/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/tariq/.config/opencode/get-shit-done/workflows/verify-phase.md` for verification logic.
