...
Key references:
- @/Users/tariq/.config/opencode/get-shit-done/references/ui-brand.md (display patterns)
- @/Users/tariq/.config/opencode/agents/gsd-user-profiler.md (profiler agent definition)
- @/Users/tariq/.config/opencode/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="/Users/tariq/.config/opencode/get-shit-done/USER-PROFILE.md"
...
```bash
cp "/Users/tariq/.config/opencode/get-shit-done/USER-PROFILE.md" "/Users/tariq/.config/opencode/USER-PROFILE.backup.md"
```
...
✓ Stores profile at /Users/tariq/.config/opencode/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `/Users/tariq/.config/opencode/get-shit-done/references/user-profiling.md`
...
Reference: @/Users/tariq/.config/opencode/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to /Users/tariq/.config/opencode/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to /Users/tariq/.config/opencode/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at /Users/tariq/.config/opencode/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at /Users/tariq/.config/opencode/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to /Users/tariq/.config/opencode/AGENTS.md"
...
```bash
BACKUP_PATH="/Users/tariq/.config/opencode/USER-PROFILE.backup.md"
```
...
Your profile:    /Users/tariq/.config/opencode/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   /Users/tariq/.config/opencode/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       ./AGENTS.md
  ✓ Global AGENTS.md        /Users/tariq/.config/opencode/AGENTS.md
```
