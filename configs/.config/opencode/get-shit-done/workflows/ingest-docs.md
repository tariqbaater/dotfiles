...
```bash
INIT=$(node "/Users/tariq/.config/opencode/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/tariq/.config/opencode/get-shit-done/bin/gsd-tools.cjs" commit \
