...
INSTALL_JS_GLOBAL="/Users/tariq/.config/opencode/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/tariq/.config/opencode/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
