...
<required_reading>
@/Users/tariq/.config/opencode/get-shit-done/references/ai-frameworks.md
@/Users/tariq/.config/opencode/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/tariq/.config/opencode/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/tariq/.config/opencode/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/tariq/.config/opencode/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/tariq/.config/opencode/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/tariq/.config/opencode/agents/gsd-eval-planner.md for instructions.
