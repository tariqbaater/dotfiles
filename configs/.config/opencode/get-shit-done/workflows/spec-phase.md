...
```bash
INIT=$(node "/Users/tariq/.config/opencode/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/tariq/.config/opencode/get-shit-done/templates/spec.md.
